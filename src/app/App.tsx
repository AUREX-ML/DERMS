...
// Uncomment below to use Version 1 (DERMS Grid Dashboard)
/*
...
export default function App() {
  // Version 2: Commercial Real Estate VPP Dashboard
  return <AppV2 />;
}

// VERSION 1 CODE (DERMS Grid Dashboard) - Uncomment to use
/*
